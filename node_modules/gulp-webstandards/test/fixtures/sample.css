...
body.admin-bar #cover:hover~.featured-bar, body.admin-bar .featured-bar:hover {top: 82px;}
...
.navbar h1{margin:0;}
.navbar .logo-img{position: absolute; top:0;left:20px}
...
.featured .item-featured{position: relative;overflow:hidden;padding:0;}
	...
	.item-featured-single{position: relative;overflow:hidden;padding:0;height: 80%;display:block; float:left;width: 100%; z-index: 10;}
		...
		.featured-bar strong{text-transform: uppercase; font-weight: 700;color:#00ecbe}
		.featured-bar a{color:#fff;padding:0 10px}
		.featured-bar a i{color:#666;padding-right:5px;} 
		
		#cover:hover~.featured-bar, .featured-bar:hover, .link-featured-single:hover~.featured-bar{top:50px}
...
.single{border-left: 1px solid #eee;padding:0;margin:0;}
	...
	.sing-fullscreen{font-size: 16px;}
	.sing-cop{width:100%; height:auto;}
	.sing-tit-cont-short{position: relative;margin:-69px 0 0 0;margin-left:10%; padding:3% 5% 1% 5%;width:80%;background:#fff;}
	.sing-tit-cont{position: relative;margin:-300px 0 0 0;margin-left:10%; padding:3% 5% 1% 5%;width:80%;background:#fff;}
	.sing-tit{margin:10px 0 20px 0; text-transform: uppercase; font-weight: 300;font-size: 33px;}
	.sing-tit-fullscreen{margin:40px 0 20px 0;font-size:42px; }
	.sing-spacer{padding:3% 6%;}
	.sing-cont{position: relative;margin-left:10%;width:80%;font-size: 16px; line-height: 26px;background:#fff;}
	.single-in{padding:0;}
	...
	.sharrre-container { float: left; width:100%; padding: 10px 0 20px 0; margin-top:30px;border-top: 1px solid #eee;}
...
.sidebar{}	
	...
	.widget{padding: 10px 10px 20px 10px;}
	.widget h3{text-transform: uppercase;font-weight:700;font-size: 16px;}
	.widget a{ display:block; padding: 10px 15px;border-bottom: 1px solid #eee;}
...
.btn-noborder{border: none; background: none;}
...
@media (max-width: 760px) { 
	...
	.sing-tit-cont-short{margin-left:5%; width:90%;}
